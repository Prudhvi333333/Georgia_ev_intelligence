...
def check_db_connection():
    from collector.shared.db import verify_connection, get_session
...
def check_db_columns():
    from collector.shared.db import get_session
    from sqlalchemy import text
    session = get_session()
    try:
...
def check_seed_sqls():
    from collector.shared.db import get_session
    from sqlalchemy import text
    from generator.phase5_fewshot.seed_store import SQL_EXAMPLES
...
# ─────────────────────────────────────────────────────────────────────────────
def check_embedder():
    from generator.phase5_fewshot.embedder import embed_text, check_embed_model_available, _EMBED_DIM
...
def check_qdrant_store():
    ...
    from generator.phase5_fewshot.qdrant_store import upsert_example, search_similar, count_examples
    from generator.phase5_fewshot.embedder import embed_text
...
# ─────────────────────────────────────────────────────────────────────────────
def check_retriever():
    from generator.phase5_fewshot.few_shot_retriever import get_few_shot_examples, get_few_shot_block
...
# ─────────────────────────────────────────────────────────────────────────────
def check_full_seed():
    from generator.phase5_fewshot.seed_store import SQL_EXAMPLES, CYPHER_EXAMPLES
    from generator.phase5_fewshot.qdrant_store import upsert_example, count_examples, delete_collection
    from generator.phase5_fewshot.embedder import embed_text
...
def check_integration():
    from generator.phase5_fewshot.few_shot_retriever import get_few_shot_block
