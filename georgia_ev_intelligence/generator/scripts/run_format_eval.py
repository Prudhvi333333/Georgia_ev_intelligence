...
from generator.evaluate.format_runner import (
...
_OUTPUT_DIR = _GENERATOR_ROOT / "outputs" / "format_eval"
...
def load_eval_questions() -> list[dict]:
    ...
    """
    q_path = _GENERATOR_ROOT / "outputs" / "questions_export.json"
    if q_path.exists():
    ...
    try:
        from generator.scripts.run_ragas_eval import SMOKE_QUESTIONS
...
def main():
    ...
    if args.dashboard_only:
        ...
        from generator.scripts.generate_dashboard import generate_dashboard
        generate_dashboard()
        return
