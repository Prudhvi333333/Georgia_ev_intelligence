...
RUN THIS ONCE to populate the store:
    venv\\Scripts\\python -m generator.phase5_fewshot.seed_store
...
from generator.phase5_fewshot.embedder import embed_text, check_embed_model_available
...
def seed(wipe_first: bool = False) -> None:
    ...
    print(f"   Store path: generator/outputs/fewshot_store/")
