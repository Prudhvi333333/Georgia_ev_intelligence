...
from collector.shared.db import create_tables, get_engine, get_session, verify_connection
...
async def run_phase1_10(all_companies: list[dict]) -> None:
    ...
    from collector.phase1_extraction.pipeline import run_pipeline, print_summary
