...
from collector.shared.db import get_engine, get_session, Company, create_tables
...
if __name__ == "__main__":
    ...
    print("\n✅ Done. Next steps:")
    print("   venv\\Scripts\\python -m collector.phase3_graph.pipeline")
    print("   venv\\Scripts\\python collector\\scripts\\sync_neo4j.py")
    print("   venv\\Scripts\\python generator\\scripts\\smoke_test_phase4.py")
