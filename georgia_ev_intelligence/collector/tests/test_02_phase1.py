...
class TestKbLoader(unittest.TestCase):
    ...
    def test_excel_can_be_found(self):
        ...
        from collector.phase1_extraction.kb_loader import _find_gnem_excel
    ...
    def test_excel_has_205_rows(self):
        ...
        from collector.phase1_extraction.kb_loader import load_companies_from_excel
    ...
    def test_db_sync(self):
        ...
        from collector.phase1_extraction.kb_loader import (
    ...
    def test_build_document_text(self):
        ...
        from collector.phase1_extraction.kb_loader import build_document_text
        company = {
...
class TestQueryGenerator(unittest.TestCase):
    ...
    def test_queries_generated(self):
        from collector.phase1_extraction.query_generator import build_queries
    ...
    def test_estimate_query_count(self):
        from collector.phase1_extraction.query_generator import estimate_query_count
...
class TestExtractor(unittest.TestCase):
    ...
    def test_pdf_bytes_extraction(self):
        ...
        from collector.phase1_extraction.extractor import extract_pdf_bytes
    ...
    def test_is_pdf_url_detection(self):
        ...
        from collector.phase1_extraction.extractor import _is_pdf_url
    ...
    def test_tavily_extract_called_for_html(self):
        ...
        import collector.phase1_extraction.extractor as extractor_mod
        ...
        try:
            ...
            try:
                from collector.phase1_extraction.extractor import extract_document
...
class TestEntityExtractor(unittest.TestCase):
    ...
    def test_json_parsing_valid(self):
        ...
        from collector.phase1_extraction.entity_extractor import _parse_facts_json
    ...
    def test_extract_facts_calls_ollama(self):
        ...
        from collector.phase1_extraction.entity_extractor import extract_facts
    ...
    def test_low_confidence_filtered(self):
        ...
        from collector.phase1_extraction.entity_extractor import save_facts_to_db
        facts = [
            {
                "company_id": None,
                "document_id": None,
...
class TestSearcher(unittest.TestCase):
    ...
    def test_blocklist_filtering(self):
        ...
        from collector.phase1_extraction.searcher import _is_blocked
    ...
    def test_priority_detection(self):
        from collector.phase1_extraction.searcher import _is_priority
    ...
    def test_tavily_search_called(self):
        ...
        from collector.phase1_extraction.searcher import tavily_search
