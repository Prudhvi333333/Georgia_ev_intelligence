...
Usage:
  ...
  python -m collector.phase1_extraction.pipeline

  # Test run (first N companies):
  python -m collector.phase1_extraction.pipeline --limit 3

  # Single company (by name):
  python -m collector.phase1_extraction.pipeline --company "Hanwha Q Cells"

  # Skip extraction, only load GNEM to DB:
  python -m collector.phase1_extraction.pipeline --load-only
"""
...
from collector.phase1_extraction.doc_storage import (
    get_document_count_for_company,
    mark_document_failed,
    save_document,
)
from collector.phase1_extraction.entity_extractor import extract_facts, save_facts_to_db
...
from collector.phase1_extraction.query_generator import build_queries, estimate_query_count
from collector.phase1_extraction.searcher import search_company
